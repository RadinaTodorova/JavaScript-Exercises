function race(input) {
  ...
  let sortedArrayOfParticipants = Object.entries(objOfParticipants).sort(
    (a, b) => b[1] - a[1]
  );

  console.log(`1st place: ${sortedArrayOfParticipants[0][0]}`);
  console.log(`2nd place: ${sortedArrayOfParticipants[1][0]}`);
  console.log(`3rd place: ${sortedArrayOfParticipants[2][0]}`);
}
race([
